			...
			$("#loginBtn").click(function(){
				...
				$.ajax({
					...
					success:function(data){
						if(data.code=="1"){
						// 	跳转到主页面
							window.location.href="workench/index.do";
					...
					beforeSend:function(){
					// 	当ajax向后台发送请求前，会执行本函数，该函数的返回值能够决定ajax是否真正向后台发请求
						// 	返回值为true后才可以继续发送请求，为false则停止发送请求
						//     表单验证
						// 显示正在验证
						$("#msg").html("正在验证，请稍等....");
						return true;
			...
			<form action="workbench/index.html" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					<div style="width: 350px;">
						<input id="loginAct" class="form-control" type="text" value="${cookie.loginPwd.value}" placeholder="用户名">
					</div>
					<div style="width: 350px; position: relative;top: 20px;">
						<input id="loginPwd" class="form-control" type="password" value="${cookie.loginAct.value}
" placeholder="密码">
					</div>
